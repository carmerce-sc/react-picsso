...
import React__default, { forwardRef, useContext, useMemo } from 'react';
...
var createStyledElement = function createStyledElement(tagName) {
  return /*#__PURE__*/React__default.memo( /*#__PURE__*/forwardRef(function (_a, ref) {
    ...
    var _b = seperateStyleString(props, customConfig),
      styleString = _b[0],
      otherProps = _b[1];
    // 사용 useMemo로 스타일 컴포넌트 재생성 최소화
    var StyledComponent = useMemo(function () {
      return newStyled(tagName)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n            ", "\n            ", "\n          "], ["\n            ", "\n            ", "\n          "])), function (props) {
        return props.css || "";
      }, styleString);
    }, [styleString, tagName]);
    return /*#__PURE__*/React__default.createElement(StyledComponent, __assign({
      ref: ref
    }, otherProps), children);
  }));
};
